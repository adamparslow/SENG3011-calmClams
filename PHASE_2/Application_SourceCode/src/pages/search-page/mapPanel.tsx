...
const style={height: "95vh", width: "100%", backgroundColor: "#00A8E8"};
...
const MapPanel = () => {
    ...
    useEffect(() => {
        ...
        polygonTemplate.polygon.fillOpacity = 0.6;
            polygonTemplate.fill = am4core.color('007EA7');
        ...
        imageSeries.mapImages.template.tooltipHTML = "<h1>{title}<h1>";
